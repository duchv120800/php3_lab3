...
<!-- Mirrored from template.hasthemes.com/rideo/rideo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jun 2024 08:22:40 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Version One || Rideo</title>
        <meta name="description" content="Rideo – Bicycle Store HTML Template is a clean and elegant design – suitable for accessories, bicycle, biking, clean, creative, mountain biking, responsive, store, sport, interior, shopping. It has a fully responsive width adjusts automatically to any screen size or resolution.">
    ...
    <body>
					...
					<div class="row">
						<div class="col-12 header-bottom-bg">
							<div class="logo floatleft">
								<a href="index.html">
									<img src="img/logo.png" width="139" height="60" alt="Rideo" />
								</a>
							</div>
											...
											<ul class="mega-menu">
												...
												<li>
													<div class="banner-hover">
														<a href="#"><img alt="Banner" src="img/banner.jpg" width="177" height="274"></a>
													</div>
												</li>
											</ul>
										</li>
							...
							<div class="cart-menu-area floatright">
								<ul>
									<li><a href="#"><i class="pe-7s-shopbag"></i> <span>2</span></a>
										<ul class="cart-menu">
											<li>
												<a href="cart.html"><img src="img/cart/1.png" width="85" height="81" alt="" /></a>
		...
		<div class="slider-area slider-one clearfix">
			<div class="slider animation-style-01">
				<div class="slider-item" data-bg-image="img/slider/1.jpg">
					<div class="d-table">
								...
								<div class="row">
									<div class="col-12">
										<div class="slide-text">
											<h2 class="title">best cycling experience</h2>
											<div class="shape">
												<img src="img/slider/shape.png" width="30" height="30" alt="" />
											</div>
											<h3 class="sub-title">become the world leader on the internet for the sport of cycling.</h3>
				...
				<div class="slider-item" data-bg-image="img/slider/2.jpg">
					<div class="d-table">
						<div class="d-tablecell">
							<div class="container">
								<div class="row">
				...
				<div class="row">
					<div class="col-md-8 col-lg-6 col-text-center">
						<div class="section-title text-center">
							...
							<div class="shape">
								<img src="img/icon/t-shape.png" width="16" height="16" alt="Title Shape" />
							</div>
						...
						<div class="featured-slider single-products">
							<div class="product-item-wrap">
								<div class="padding30">
									<div class="product-item">
										<div class="pro-img">
											<a href="product-details.html"><img src="img/products/1.png" width="318" height="194" alt="" /></a>
										</div>
										...
										<div class="product-title">
											<a href="product-details.html"><h3 class="title">Mount POW C058 FG</h3></a>
							...
							<div class="product-item-wrap">
								<div class="padding30">
									<div class="product-item">
										<div class="pro-img">
											<a href="product-details.html"><img src="img/products/3.png" width="318" height="194" alt="" /></a>
										</div>
										<div class="actions-btn">
											<ul class="clearfix">
												<li>
							...
							<div class="product-item-wrap">
								<div class="padding30">
									<div class="product-item">
										<div class="pro-img">
											<a href="product-details.html"><img src="img/products/2.png" width="318" height="194" alt="" /></a>
										</div>
										<div class="actions-btn">
											<ul class="clearfix">
												<li>
		...
		<section class="sell-up-area sell-up-one">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 offset-lg-1 col-lg-7">
						<div class="sell-up-right">
							<div class="single-sellup">
								<a href="product-details.html"><img src="img/products/u1.png" width="582" height="343" alt="" /></a>
							</div>
							<div class="single-sellup">
								<a href="product-details.html"><img src="img/products/u1.png" width="582" height="343" alt="" /></a>
							</div>
		...
		<section class="riding-area riding-one section-padding">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-lg-6 col-text-center">
						<div class="section-title text-center">
							<h2><span>riding</span> accessories</h2>
							<div class="shape">
								<img src="img/icon/t-shape.png" width="16" height="16" alt="Title Shape" />
							</div>
					...
					<div class="col-12">
						<div class="four-item riding-slider single-products">
							<div class="product-item-wrap">
								<div class="product-item">
									<div class="pro-img">
										<a href="product-details.html"><img src="img/products/r1.png" width="263" height="282" alt="Product" /></a>
										<div class="link-icon">
									...
									<div class="riding-title clearfix">
										<div class="product-title text-start floatleft">
											<a href="product-details.html"><h3 class="title">Giro Cipher Helmet</h3></a>
											<p><span>$150</span></p>
										</div>
							...
							<div class="product-item-wrap">
								<div class="product-item">
									<div class="pro-img">
										<a href="product-details.html"><img src="img/products/r2.png" width="263" height="282" alt="Product" /></a>
										<div class="link-icon">
											<a href="product-details.html"><i class="fa fa-link"></i></a>
										</div>
									</div>
							...
							<div class="product-item-wrap">
								<div class="product-item">
									<div class="pro-img">
										<a href="product-details.html"><img src="img/products/r3.png" width="263" height="282" alt="Product" /></a>
										<div class="link-icon">
											<a href="product-details.html"><i class="fa fa-link"></i></a>
										</div>
									</div>
							...
							<div class="product-item-wrap">
								<div class="product-item">
									<div class="pro-img">
										<a href="product-details.html"><img src="img/products/r4.png" width="263" height="282" alt="Product" /></a>
										<div class="link-icon">
											<a href="product-details.html"><i class="fa fa-link"></i></a>
										</div>
									</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="discount-right">
							<img src="img/products/d1.png" width="555" height="354" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12 text-center">
						<div class="tab-menu">
							<ul class="nav">
								<li>
									<a class="active" data-bs-toggle="tab" href="#bikes">Bikes <span>-</span></a>
								</li>
								<li>
									<a data-bs-toggle="tab" href="#parts">Parts <span>-</span></a>
								</li>
								<li>
									<a data-bs-toggle="tab" href="#man">Man <span>-</span></a>
								</li>
								<li>
									<a data-bs-toggle="tab" href="#women">Women <span>-</span></a>
								</li>
								<li>
									<a data-bs-toggle="tab" href="#accessories">Accessories</a>
								</li>
							</ul>
						</div>
					</div>
						...
						<div class="tab-pane fade show active" id="bikes">
							<div class="four-item single-products">
								<div class="product-item-wrap">
									<div class="product-item">
										<div class="pro-img">
											<a href="product-details.html"><img src="img/products/b1.png" width="241" height="195" alt="Product" /></a>
										</div>
										<div class="actions-btn">
											<ul class="clearfix">
												<li>
										...
										<div class="riding-title clearfix">
											<div class="product-title">
												<a href="product-details.html"><h3 class="title">T Mounten bike S900</h3></a>
		...
		<section class="arrival-area arrival-one section-padding-top">
			...
			<div class="container-fluid arrival-content">
				<div class="row text-center">
					<div class="col-md-6 col-lg-4 arrival-left">
						<div class="single-arrival left">
							<div class="product-item">
								<div class="pro-img">
									<a href="product-details.html"><img src="img/products/ssl.jpg" width="604" height="717" alt="Product" /></a>
								</div>
								<div class="tag-new">
								...
								<div class="arrival-title clearfix">
									<div class="product-title">
										<a href="product-details.html"><h2 class='title'>Mountain Bike MZ 5500J</h2></a>
					...
					<div class="col-md-6 col-lg-4 arrival-middle">
						<div class="single-arrival middel">
							<div class="row">
								<div class="col-md-6">
									<div class="product-item">
										<div class="pro-img">
											<a href="product-details.html"><img src="img/products/ss.jpg" width="287" height="287" alt="Product" /></a>
										</div>
										<div class="actions-btn">
											<ul class="clearfix">
												<li>
										...
										<div class="arrival-title clearfix">
											<div class="product-title">
												<a href="product-details.html"><h3 class="title">Mountain Bike</h3></a>
								...
								<div class="col-md-6">
									<div class="product-item margin-top mt-md-0">
										<div class="pro-img">
											<a href="product-details.html"><img src="img/products/ss.jpg" width="287" height="287" alt="Product" /></a>
										</div>
										<div class="actions-btn">
					...
					<div class="col-md-6 col-lg-4 arrival-left">
						<div class="single-arrival right">
							<div class="product-item">
								<div class="pro-img">
									<a href="product-details.html"><img src="img/products/ssr.jpg" width="604" height="717" alt="Product" /></a>
								</div>
								<div class="tag-new">
									<img src="img/products/tag.png" alt="New Tag" />
								</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 col-lg-4">
						<div class="blog-item">
							<div class="blog-img">
								<a href="product-details.html"><img src="img/blog/1.jpg" width="360" height="253" alt="Blog" /></a>
							</div>
					...
					<div class="col-md-6 col-lg-4">
						<div class="blog-item middel">
							...
							<div class="blog-img">
								<a href="product-details.html"><img src="img/blog/2.jpg" width="360" height="253" alt="Blog" /></a>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 pt-4 pt-lg-0">
						<div class="blog-item">
							<div class="blog-img">
								<a href="product-details.html"><img src="img/blog/3.jpg" width="360" height="253" alt="Blog" /></a>
							</div>
							<div class="blog-text clearfix">
								<hr class="line"/>
								<a href="single-blog.html"><h4>Lights & Motion Night Light</h4></a>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="left">
													...
													<div class="quick-img">
														<img src="img/products/l1.jpg" width="524" height="554" alt="" />
													</div>	
					...
					<div class="row">
						<div class="col-12">
							<div class="brand-logo">
								<ul class="clearfix">
									<li>
										<a href="#"><img src="img/brand/1.png" width="170" height="88" alt="Brand Logo" /></a>
									</li>
									<li>
										<a href="#"><img src="img/brand/2.png" width="170" height="88" alt="Brand Logo" /></a>
									</li>
									<li>
										<a href="#"><img src="img/brand/3.png" width="170" height="88" alt="Brand Logo" /></a>
									</li>
									<li>
										<a href="#"><img src="img/brand/4.png" width="170" height="88" alt="Brand Logo" /></a>
									</li>
									<li>
										<a href="#"><img src="img/brand/5.png" width="170" height="88" alt="Brand Logo" /></a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="right mayment-card floatright">
								<ul>
									<li>
										<a href="#"><img src="img/footer/v1.png" width="39" height="27" alt="Payment Card" /></a>
									</li>
									<li>
										<a href="#"><img src="img/footer/v2.png" width="39" height="27" alt="Payment Card" /></a>
									</li>
									<li>
										<a href="#"><img src="img/footer/v3.png" width="39" height="27" alt="Payment Card" /></a>
									</li>
									<li>
										<a href="#"><img src="img/footer/v4.png" width="39" height="27" alt="Payment Card" /></a>
									</li>
								</ul>
							</div>
						</div>
...
<!-- Mirrored from template.hasthemes.com/rideo/rideo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jun 2024 08:22:48 GMT -->
</html>
